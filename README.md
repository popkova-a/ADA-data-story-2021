...
<div>
  <script>
  function openComm(evt, yearName) {
    var i, tabcontent, tablinks;
  ...
  <!-- Tab links -->
  <div class="tab">
    <button class="tablinks" onclick="openComm(event, '2015_')" id="defaultOpen_">2015</button>
    <button class="tablinks" onclick="openComm(event, '2016_')">2016</button>
    <button class="tablinks" onclick="openComm(event, '2017_')">2017</button>
    <button class="tablinks" onclick="openComm(event, '2018_')">2018</button>
    <button class="tablinks" onclick="openComm(event, '2019_')">2019</button>
    <button class="tablinks" onclick="openComm(event, '2020_')">2020</button>
  </div>
